...
Der RecipeReplacer verwendet eine Recipe-Datei des Datentypen TextAsset\footnote{Text Assets in Unity: \cite[Seite: class-TextAsset]{unityManual}}. In der Text-Datei ist festgelegt in welcher Reihenfolge die Regeln aus RuleSet angewandt werden. Das genaue Format des Recipes ist in \ref{s.regelsystem} beschrieben.
...
\section{Regelsystem}\label{s.regelsystem}
...
In der Rezept-Datei ist jede Zeile eine Anweisung, es existieren die in Tabelle \ref{t.anweisungen} aufgelisteten Anweisungen.
...
\todo{Spezialfall Cellular Automaton, P-System} 
...
\todo{Easybuttons}
\todo{Dungeon-Tileset für Tür}\label{m.tuer}
\todo{Asset Forge}
